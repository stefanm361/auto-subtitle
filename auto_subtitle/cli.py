...
def main():
    ...
    for path, srt_path in subtitles.items():
        ...
        ffmpeg.concat(
            video.filter('subtitles', srt_path, force_style="Fontsize={},Fontname=Helvetica-Bold,PrimaryColour=&H00FFFF&,Alignment=0,MarginL=250 MarginV=500".format(font_size)), audio, v=1, a=1
